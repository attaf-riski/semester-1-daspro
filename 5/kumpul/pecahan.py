...
Pecahan_1 = Pecahan(1,5)
print("Pecahan 1 terbentuk dengan nilai: {0}/{1}".format(pemb(Pecahan_1),peny(Pecahan_1)))
Pecahan_2 = Pecahan(3,5)
print("Pecahan 2 terbentuk dengan nilai: {0}/{1}".format(pemb(Pecahan_2),peny(Pecahan_2)))

print("\n==SESI OPERASI ARITMATIKA PECAHAN==\n")
print("Apakah Pecahan 1 sama dengan (==) Pecahan 2?: {}".format(is_eq_f(Pecahan_1,Pecahan_2)))
print("Apakah Pecahan 1 kurang dari (<=) Pecahan 2?: {}".format(is_lt_f(Pecahan_1,Pecahan_2)))
print("Apakah Pecahan 1 lebih dari (>=) Pecahan 2?: {}".format(is_gt_f(Pecahan_1,Pecahan_2)))

print("\n==SESI OPERASI RELASIONAL PECAHAN==\n")
print("Kita ingat kembali bahwa Pecahan 1 adalah: {0}/{1}".format(pemb(Pecahan_1),peny(Pecahan_1)))
print("Dan Kita ingat kembali bahwa Pecahan 2 adalah: {0}/{1}".format(pemb(Pecahan_2),peny(Pecahan_2)))
Pecahan_buffer = add_f(Pecahan_1,Pecahan_2)
print("Pecahan 1 + Pecahan 2 = {}/{}".format(pemb(Pecahan_buffer),peny(Pecahan_buffer)))
Pecahan_buffer = sub_f(Pecahan_1,Pecahan_2)
print("Pecahan 1 - Pecahan 2 = {}/{}".format(pemb(Pecahan_buffer),peny(Pecahan_buffer)))
Pecahan_buffer = mul_f(Pecahan_1,Pecahan_2)
print("Pecahan 1 * Pecahan 2 = {}/{}".format(pemb(Pecahan_buffer),peny(Pecahan_buffer)))
Pecahan_buffer = div_f(Pecahan_1,Pecahan_2)
print("Pecahan 1 / Pecahan 2 = {}/{}".format(pemb(Pecahan_buffer),peny(Pecahan_buffer)))
print("Bentuk desimal Pecahan 1 adalah = {}".format(real_f(Pecahan_1)))
print("Bentuk desimal Pecahan 2 adalah = {}".format(real_f(Pecahan_2)))
